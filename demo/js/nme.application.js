...
ApplicationMain.preloader_onComplete = function(event) {
	...
	if(Reflect.field(tests.Test,"main") == null) {
		var mainDisplayObj = new tests.Test();
		if(js.Boot.__instanceof(mainDisplayObj,jeash.display.DisplayObject)) nme.Lib.nmeGetCurrent().addChild(mainDisplayObj);
	} else Reflect.field(tests.Test,"main").apply(tests.Test,[]);
}
...
var com = {}
com.designerzen = {}
com.designerzen.controllers = {}
com.designerzen.controllers.StageMediator = function() {
	jeash.events.EventDispatcher.call(this);
	this.timer = new jeash.utils.Timer(50,1);
	this.timeStamp = jeash.Lib.getTimer();
	this.stage = nme.Lib.nmeGetCurrent().getStage();
	this.viewPort = new jeash.geom.Rectangle(0,0,this.stage.jeashGetStageWidth(),this.stage.jeashGetStageHeight());
	this.stage.addEventListener(jeash.events.Event.RESIZE,$bind(this,this.onStageResizing));
	this.timer.addEventListener("timer",$bind(this,this.onStageResized));
};
$hxClasses["com.designerzen.controllers.StageMediator"] = com.designerzen.controllers.StageMediator;
com.designerzen.controllers.StageMediator.__name__ = ["com","designerzen","controllers","StageMediator"];
com.designerzen.controllers.StageMediator.__super__ = jeash.events.EventDispatcher;
com.designerzen.controllers.StageMediator.prototype = $extend(jeash.events.EventDispatcher.prototype,{
	onStageResized: function(event) {
		this.timeStamp = jeash.Lib.getTimer();
		this.dispatch();
		this.timer.stop();
	}
	,onStageResizing: function(event) {
		if(this.viewPort.width == this.stage.jeashGetStageWidth() && this.viewPort.height == this.stage.jeashGetStageHeight()) return;
		var now = jeash.Lib.getTimer();
		...
		if(this.viewPort.width < this.stage.jeashGetStageWidth() || this.viewPort.height < this.stage.jeashGetStageHeight()) {
			this.dispatch();
			return;
		}
	...
	,dispatch: function() {
		this.viewPort.width = this.stage.jeashGetStageWidth();
		this.viewPort.height = this.stage.jeashGetStageHeight();
		this.dispatchEvent(new com.designerzen.models.events.ResizeEvent(this.stage.jeashGetStageWidth(),this.stage.jeashGetStageHeight()));
	}
	,getHeight: function() {
		return this.viewPort.height | 0;
	}
	,getWidth: function() {
		return this.viewPort.width | 0;
	}
	,getAspectRatio: function() {
		return this.viewPort.width / this.viewPort.height;
	}
	,__class__: com.designerzen.controllers.StageMediator
});
...
com.designerzen.models = {}
com.designerzen.models.events = {}
com.designerzen.models.events.ResizeEvent = function(stageWidth,stageHeight,bubbles,cancelable) {
	if(cancelable == null) cancelable = false;
	if(bubbles == null) bubbles = false;
	this.width = stageWidth;
	this.height = stageHeight;
	jeash.events.Event.call(this,"stageResized",bubbles,cancelable);
};
$hxClasses["com.designerzen.models.events.ResizeEvent"] = com.designerzen.models.events.ResizeEvent;
com.designerzen.models.events.ResizeEvent.__name__ = ["com","designerzen","models","events","ResizeEvent"];
com.designerzen.models.events.ResizeEvent.__super__ = jeash.events.Event;
com.designerzen.models.events.ResizeEvent.prototype = $extend(jeash.events.Event.prototype,{
	clone: function() {
		return new com.designerzen.models.events.ResizeEvent(this.width,this.height,this.bubbles,this.cancelable);
	}
	,__class__: com.designerzen.models.events.ResizeEvent
});
com.designerzen.views = {}
com.designerzen.views.layout = {}
com.designerzen.views.layout.FlexibleStage = function() {
	jeash.display.Sprite.call(this);
	this.addEventListener(jeash.events.Event.ADDED_TO_STAGE,$bind(this,this.onAddedToStage));
};
$hxClasses["com.designerzen.views.layout.FlexibleStage"] = com.designerzen.views.layout.FlexibleStage;
com.designerzen.views.layout.FlexibleStage.__name__ = ["com","designerzen","views","layout","FlexibleStage"];
com.designerzen.views.layout.FlexibleStage.__super__ = jeash.display.Sprite;
com.designerzen.views.layout.FlexibleStage.prototype = $extend(jeash.display.Sprite.prototype,{
	resize: function(stageWidth,stageHeight) {
		throw new jeash.errors.Error("You must over-ride the resize() method in your class but do *not* call super.resize() from within");
	}
	,onStageResized: function(event) {
	...
	,onAddedToStage: function(e) {
		this.removeEventListener(jeash.events.Event.ADDED_TO_STAGE,$bind(this,this.onAddedToStage));
		if(com.designerzen.views.layout.FlexibleStage.stageManager == null) com.designerzen.views.layout.FlexibleStage.stageManager = new com.designerzen.controllers.StageMediator();
		com.designerzen.views.layout.FlexibleStage.stageManager.addEventListener("stageResized",$bind(this,this.onStageResized));
		this.resize(this.getStage().jeashGetStageWidth(),this.getStage().jeashGetStageHeight());
		this.added();
	}
	,__class__: com.designerzen.views.layout.FlexibleStage
});
var haxe = {}
		...
		case "keydown":
			...
			var keyCode = evt1.keyIdentifier != null?(function($this) {
				...
				try {
					...
					$r = (function($this) {
						var $r;
						jeash.Lib.trace("keydown error: " + Std.string(e));
						$r = evt1.keyCode;
						return $r;
					}($this));
				}
		...
		case "keyup":
			...
			var keyCode = evt1.keyIdentifier != null?(function($this) {
				...
				try {
					...
					$r = (function($this) {
						var $r;
						jeash.Lib.trace("keyup error: " + Std.string(e));
						$r = evt1.keyCode;
						return $r;
					}($this));
				}
...
jeash.events.TimerEvent = function(type,bubbles,cancelable) {
	jeash.events.Event.call(this,type,bubbles,cancelable);
};
$hxClasses["jeash.events.TimerEvent"] = jeash.events.TimerEvent;
...
jeash.utils.Endian = $hxClasses["jeash.utils.Endian"] = { __ename__ : true, __constructs__ : ["BIG_ENDIAN","LITTLE_ENDIAN"] }
...
jeash.utils.Timer = function(delay,repeatCount) {
...
$hxClasses["jeash.utils.Timer"] = jeash.utils.Timer;
jeash.utils.Timer.__name__ = ["jeash","utils","Timer"];
jeash.utils.Timer.__super__ = jeash.events.EventDispatcher;
jeash.utils.Timer.prototype = $extend(jeash.events.EventDispatcher.prototype,{
	__setRepeatCount: function(v) {
		if(this.running && v != 0 && v <= this.currentCount) this.stop();
		this.repeatCount = v;
		return v;
	}
	,__setDelay: function(v) {
		if(v != this.delay) {
	...
	,__onInterval: function() {
		...
		if(this.repeatCount != 0 && ++this.currentCount >= this.repeatCount) {
			this.stop();
			evtCom = new jeash.events.TimerEvent("timerComplete");
			evtCom.target = this;
		}
		var evt = new jeash.events.TimerEvent("timer");
		evt.target = this;
		this.dispatchEvent(evt);
		if(evtCom != null) this.dispatchEvent(evtCom);
	}
	,stop: function() {
	...
	,start: function() {
		...
		this.running = true;
		this.timerId = window.setTimeout($bind(this,this.__onInterval),this.delay | 0);
	}
	,reset: function() {
		this.stop();
		this.currentCount = 0;
	}
	,__class__: jeash.utils.Timer
});
...
var tests = {}
tests.Test = function() {
	com.designerzen.views.layout.FlexibleStage.call(this);
};
$hxClasses["tests.Test"] = tests.Test;
tests.Test.__name__ = ["tests","Test"];
tests.Test.__super__ = com.designerzen.views.layout.FlexibleStage;
tests.Test.prototype = $extend(com.designerzen.views.layout.FlexibleStage.prototype,{
	resize: function(stageWidth,stageHeight) {
		var halfWidth = stageWidth * 0.5 | 0;
		var halfHeight = stageHeight * 0.5 | 0;
		var radius = halfWidth > halfHeight?halfHeight:halfWidth;
		this.jeashGetGraphics().clear();
		this.jeashGetGraphics().beginFill(Math.random() * 16777215 | 0,0.5);
		this.jeashGetGraphics().drawRect(0,0,stageWidth,stageHeight);
		this.jeashGetGraphics().drawCircle(halfWidth,halfHeight,radius);
	}
	,__class__: tests.Test
});
var $_;
...
//@ sourceMappingURL=resizinator.js.map